    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
        ...
        private void novoToolStripButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                C.ValidaClasse();
                C.ValidaComplemento();
                //C.IncluirFichario("C:\\Documentos\\curso\\WindowsForms\\Fichario");
                //C.IncluirFicharioDB("Cliente"); // nome da tabela 
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            ...
            {
                Cliente.Unit C = new Cliente.Unit();
                //var ListaBusca = C.BuscarFicharioTodos("C:\\Documentos\\curso\\WindowsForms\\Fichario");
                ...
                if (FForm.DialogResult == DialogResult.OK)
                {
                    ...
                    //C = C.BuscarFichario(idSelect, "C:\\Documentos\\curso\\WindowsForms\\Fichario");
